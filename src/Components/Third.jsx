...
// const Third = () => {
//   return (
//     <div className="relative w-full h-screen bg-gray-300 flex flex-col items-center justify-center text-black px-6 overflow-hidden">
...
//       {/* 🔹 Content Section (Flex Row Layout) */}
//       <div className="flex items-center justify-between w-full max-w-6xl gap-10">

//         {/* 🔹 Left Image */}
//         <img src={first} alt="Description 1" className="w-1/4 h-[350px] rounded-lg shadow-lg object-cover" />

//         {/* 🔹 Right Image */}
//         <img src={second} alt="Description 2" className="w-1/4 h-[350px] rounded-lg shadow-lg object-cover" />

//         {/* 🔹 Text Section */}
// <div className="w-[400px] text-center mx-auto">
//   <h2 className="text-2xl font-bold text-blue-600 mb-4 -ml-6">Companies</h2>
  
//   <p className="text-4xl font-serif font-bold mb-6 w-full text-center">
